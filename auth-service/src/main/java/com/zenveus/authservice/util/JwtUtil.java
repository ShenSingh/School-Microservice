package com.zenveus.authservice.util;
...
public class JwtUtil implements Serializable {
    ...
    public String generateToken(@Valid User user) {
        System.out.println("Generating Token for: " + user.getEmail()); // Log the user email
        Map<String, Object> claims = new HashMap<>();
        claims.put("role", "ROLE_" + user.getRole()); // Ensure ROLE_ prefix is added
